...
export default function Dashboard() {
  ...
  />
        ...
        <button onClick={() => analyticsRef.current?.scrollIntoView({ behavior: 'smooth' })} style={{ marginLeft: 12, background: "#fde68a", color: "#78350f", border: "none", padding: "8px 12px", borderRadius: 8, fontWeight: 700, cursor: "pointer" }}>Analytics</button>
      ...
      <div style={{ padding: "20px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 295px", gap: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {/* Analytics Chart */}
            <div ref={analyticsRef} style={{ background: "#fff", borderRadius: 14, padding: "16px 18px", boxShadow: "0 2px 12px rgba(0,0,0,0.07)", border: "1.5px solid #fef3c7" }}>
